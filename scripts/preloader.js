...
function addPreloader(callback = null) { //Returns obj with preloader control
  let preloaderControl = {
    toggleOverlay,
    get state() {return _preloaderState}}
  let _preloaderState = 1; //1 - on; 0 - off

  let windowInnerWidth = document.documentElement.clientWidth; //можуть змінюватись при перевороті пристрою
